...
Conditions can be configured to reduce the output you see when debugging. 
These conditions can be nested (set interlace condition, then set IP/Mac condition for eg.)
