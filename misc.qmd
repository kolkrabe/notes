...
BGP Maximum Prefix - The BGP Maximum-Prefix feature allows you to control how many prefixes can be received from a neighbor.
...
Radius Auth default port 1812

BFD Precedence 7

BFD Echo Default

The `tunnel protection ipsec profile <name> shared` command on Cisco IOS/XE allows multiple GRE tunnels using the same source interface to share a single IPsec Security Association Database (SADB) and cryptographic map
